    ...
    public function handle(ISocket $socket)
    {
        ...
        switch ($this->argument('event')) {
            ...
            case "delete":
                ...
                \App\Models\Subscription::where('user_id', $agent->user_id)
                    ->where('user_subscriber_id', $agency->user_id)->delete();

                \App\Models\SubscriptionRequest::where('user_receiver_id', $agent->user_id)
                    ->where('user_sender_id', $agency->user_id)->delete();
