...
const NotificationItem = (props: INotificationItemInjectedProps) => {
  ...
  const acceptNotification = () => {
    return API.acceptNotification(item.token)
      .then(() => {
        setIsAccepted(true);
  ...
  return (
    <div className={className ? `notification-item ${className}` : 'notification-item'}>
      <div className="notification-item__header">
        <div className="notification-item__agency">
          <div className="notification-item__agency-avatar">
            <LazyLoadImage src={getContactAvatar(item.sender)} />
          </div>

          <div className="notification-item__agency-name">
            {item.sender.name}
          </div>
        </div>
...
const mapStateToProps = (state: AppState, ownProps: INotificationItemProps) => ({
